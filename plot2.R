...
png(filename = "~/exploratory_data_analysis_wk1/plot_2.png", width = 480, height = 480)
plot(energyDfSubset$dateTime, type = "n",energyDfSubset$Global_active_power, xlab = "", ylab = "Global Active Power (kilowatts")
lines(energyDfSubset$dateTime, energyDfSubset$Global_active_power)
dev.off()